...
public class InboundAuthenticationConfig implements Serializable {
    ...
    private List<InboundAuthenticationRequestConfig> inboundAuthenticationRequestConfigs = new ArrayList<>();

    /**
     * @return
     */
    public List<InboundAuthenticationRequestConfig> getInboundAuthenticationRequestConfigs() {
        return Collections.unmodifiableList(inboundAuthenticationRequestConfigs);
    }
}
